...
public class AccountDAO {
    ...
    public Account getAccountById(int id){
        ...
        try{
            ...
            String sql = "SELECT * from SocialMedia WHERE account_id = ?; ";
            PreparedStatement sm = connection.prepareStatement(sql);
    ...
    public Account createAccount(Account account){
        Connection connection= ConnectionUtil.getConnection();
        try{
            String sql = "INSERT INTO SocialMedia (account_id, username, password) VALUES (?,?,?);";
 ...
 */
    ...
    public void updateAccountName(String name, Account account){
        Connection connection = ConnectionUtil.getConnection();
        try{
            String sql ="update SocialMedia set username = ? WHERE account_id = ? ;";
            PreparedStatement sm= connection.prepareStatement(sql);
 ...
 */
    ...
    public void updatePassword(String password, Account account){
        Connection connection = ConnectionUtil.getConnection();
        try{
            String sql ="update SocialMedia set password = ? WHERE username = ? ;";
            PreparedStatement sm= connection.prepareStatement(sql);
